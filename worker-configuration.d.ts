...
declare namespace Cloudflare {
	...
	interface Env {
		...
		FRAPPE_CLIENT_ID: string;
		FRAPPE_CLIENT_SECRET: string;
		FRAPPE_BASE_URL: string;
		FRAPPE_OAUTH_BASE_URL: string;
		FRAPPE_OAUTH_AUTHORIZE_URL: string;
		FRAPPE_OAUTH_TOKEN_URL: string;
		FRAPPE_OAUTH_USERINFO_URL: string;
		FRAPPE_OAUTH_SCOPES: string;
		FRAPPE_PROJECT_VALIDATE_URL: string;
		FRAPPE_PROJECT_SYNC_URL: string;
			FRAPPE_CREDITS_SUMMARY_URL: string;
			FRAPPE_CREDITS_VALIDATE_URL: string;
			FRAPPE_CREDITS_TOPUP_URL: string;
			FRAPPE_SHARED_SECRET: string;
			FRAPPE_API_KEY: string;
			FRAPPE_API_SECRET: string;
			FRAPPE_BEARER_TOKEN: string;
		FRAPPE_STRICT_PROJECT_VALIDATION: string;
		FRAPPE_STRICT_CREDIT_VALIDATION: string;
		FRAPPE_HTTP_TIMEOUT_MS: string;
		JWT_SECRET: string;
